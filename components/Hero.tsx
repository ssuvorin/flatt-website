      ...
      <div className="max-w-7xl mx-auto px-4 py-20 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              variants={itemVariants}
              className="text-lg md:text-xl text-gray-600 mb-8 max-w-lg space-y-4"
            >
              <p>
            ...
            >
              <a
                ...
                aria-label="Download Flatt Property Management App on App Store"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center px-6 py-3 bg-black text-white rounded-xl hover:bg-gray-800 transition-colors"
                aria-label="Get Flatt Property Management App on Google Play"
              >
                <svg className="w-6 h-6 mr-3" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
