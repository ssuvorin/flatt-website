      ...
      <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-blue-100 max-w-2xl mx-auto mb-8">
            ...
            Get the mobile app now and experience the future of property management
          </p>
        </motion.div>
        ...
        >
          <a
            ...
            aria-label="Get Flatt Property Management on App Store"
          >
          ...
          <a
            ...
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center px-8 py-4 bg-white text-gray-900 rounded-xl font-semibold hover:bg-gray-100 transition-all duration-300 hover:scale-105 hover:-translate-y-1 shadow-lg"
            aria-label="Install Flatt Property Management via Google Play"
          >
            <svg className="w-8 h-8 mr-3" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.61 3,21.09 3,20.5M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12M20.16,10.81C20.5,11.08 20.75,11.5 20.75,12C20.75,12.5 20.53,12.9 20.18,13.18L17.89,14.5L15.39,12L17.89,9.5L20.16,10.81M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z"/>
            </svg>
            <div className="text-left">
              <div className="text-sm">Install from</div>
        ...
        <motion.div
          ...
          className="absolute bottom-10 left-6 md:left-20 w-8 h-8 md:w-12 md:h-12 bg-white/20 rounded-full"
        />
        ...
        <motion.div
          ...
          className="absolute top-32 left-10 md:left-32 w-6 h-6 md:w-8 md:h-8 bg-brand-yellow/30 rounded-lg transform rotate-45"
        />
      </div>
    </section>
  )
